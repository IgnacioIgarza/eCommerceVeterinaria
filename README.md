...
### - un carrito de compras con context API, con gestión de contidades,
### - administración completa del catálogo de productos mediante operaciones de creación, lectura, actualización y eliminación un carrito de compras con gestión de cantidades,
